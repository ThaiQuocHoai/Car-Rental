...
public class CarServlet extends HttpServlet {
    ...
    private final String CAR = "SearchServlet";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<String> listCate = dao.getCate();
            session.setAttribute("SELECT", "2");
            session.setAttribute("LISTCATE", listCate);
            session.setAttribute("RENTALDATE", now);
            session.setAttribute("RETURNDATE", dateFormat.format(c.getTime()));
