...
public class LoginServlet extends HttpServlet {
    ...
    private final String ERORR = "login.jsp";
    private final String SUCCESS = "home.jsp";
    private final String OTP = "otp.jsp";
        ...
        try {
            ...
            if (flag == 1) {
                ...
                if (dto != null) {
                    ...
                    request.setAttribute("FAIL", "Username or Password not found");
                }
